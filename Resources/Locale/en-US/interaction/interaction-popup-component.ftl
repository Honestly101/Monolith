...
petting-success-mercenary-cyborg = You pet {THE($target)} on {POSS-ADJ($target)} blood covered metal head
...
petting-failure-mercenary-cyborg = You reach out to pet {THE($target)}, but {SUBJECT($target)} {CONJUGATE-BE($target)} nudges you away with its knife!
